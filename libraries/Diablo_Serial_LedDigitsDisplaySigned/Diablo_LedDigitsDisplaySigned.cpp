...
void LedDigitsDisplaySigned(Diablo_Serial_4DLib Display, word hndl, int newval, word index, word left, word Digits, word MinDigits, word WidthDigit, word LeadingBlanks)
{
  word i, m, lstb, nv ;
